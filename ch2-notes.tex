...
\fntext{tft-5}{%
  ...
  sets of Parker changes, there are many different versions; the changes here
  represent a mediation of these sources. \emph{The Real Book} gives \h{Am7} (a
  vi chord) instead of \h{F7} in m.~10; Levine's \emph{Jazz Thoery Book} gives
  \h{Db7} (a tritone substitute) instead of \h{G7} in the second half of m.~3
  and does not include the seventh in the \h{F7} of m.~10; and the \emph{Charlie
  Parker Omnibook} omits both \h{D7} chords (the first in the second half of
  m.~7, the second in m.~11).\nocite{aebersold:omnibook} Most of these
  differences are minor, and over the course of a recorded performance the
  changes might vary among all of these versions. Other compositions that
  contain this progression include Parker's own ``Confirmation,'' Sonny Stitt's
  ``Jack Spratt,'' and Toots Thielemans's ``Bluesette.''}
...
\fntext{tft-7}{%
  ...
  we begin with a \h{Dm7} chord, EC gives us $(2, 5, 0) \ECarrow\ (7, 10, 3)$,
