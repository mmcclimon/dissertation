...
seen in this chapter) is in a key. To this point, we have only acknowledged
this fact simply by mentioning the key of a particular tune in our analytical
...
\emph{diatonic} circle of fifths, as shown in Figure \ref{tfe:tf-diatonic-fifths}.

\begin{figure}[tbp]
  \centerGraphic{eps/xxx.pdf}
  \caption{\tf space, conformed to the diatonic circle of fifths.}
