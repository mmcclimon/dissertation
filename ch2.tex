...
\figBeg[thbp]
  \centerGraphic[width=20em]{eps/ch2/trans-graph-large.pdf}
...
are shown in gray here (and omitted entirely in most later examples), since
these chords are not often directly connected in jazz.
...
example, that “the ii chord in C is $x$ units away from the V chord in \Eflat,”
but because \tfo{}s are rarely split up, falling back on normal pitch-class
distance is sufficient in most situations.\fn{tf-9}
