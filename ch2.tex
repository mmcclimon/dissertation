...
between most I\tsup{7} and ii\tsup{7} chords is the transformation
...
to our analysis in Section \ref{sec:ceora-analysis}, but the key areas does
not appear so distant from one another, and the global tonic of \Aflat\ is
clearer. While the purpose of the \slideS transformation in mm.~5--6 of was
perhaps unclear in chromatic \tf space (it represents quite a large jump in
Figure \ref{tf:ceora-space-1}), this diatonic stepwise arrangement clarifies
its role, connecting the local key areas of \Dflat\ and C.


\begin{figure}[tbp] \centerGraphic{eps/xxx.pdf}
