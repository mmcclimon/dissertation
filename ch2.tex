...
\mbox{\h{ii7b5}--\h{V7b9}--\h{i\thinspace{}mM7}}: all of the chords are diatonic in
the harmonic minor key, which results in the flatted fifth in the ii chord
(\flat\sd6), the flatted ninth of the V chord (again, \flat\sd6), and the
major seventh in the minor tonic chord (the leading tone).\fn{tfe-1} Because
...
Figure \ref{tfe:tf-minor-tonics} shows a small portion of \tf space including
...
paragraph are readily apparent in the space; worthy of special attention is
the new relationship between a tonic minor-major seventh and the ii\tsup{7}
chord a fifth below---between \h{CmM7} and \h{Cm7}, for example. Though we
...
% need an example here: black orpheus?
