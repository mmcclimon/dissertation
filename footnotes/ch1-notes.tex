...
\fntext{tt-4}{%
  ...
  Tonnetz and his three-dimensional tetrachordal version as
...
\fntext{ds-11b}{%
  Recall the discussion in the preface (page \pageref{sec:notes-to-reader}):
...
\fntext{ds-18}{%
  ...
  \h{Fmaj7} as a pivot (functioning simultaneously as IV and VI), in order to
...
\fntext{ds-19}{%
  ...
  emphatically on \h{Cmaj7} in the fourth bar of the bridge on \emph{Jamal at
  the Pershing, Vol.~2}.\nocite{jamal:pershing}}

\fntext{ds-20}{%
  If the linking dominant did not appear at the end of the bridge, we would see
  the succession \h{Emaj7}--\h{Fm7}. This succession is remarkably similar to
