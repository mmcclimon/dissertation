...
\fntext{mts-5}{%
  ...
  post-tonal jazz harmony using the Tonnetz and hyper-hexatonic systems familiar
...
\fntext{maj3-13}{%
  ...
  notes from the nonatonic collection, which is acceptable because ``the
  fourth voice is not essential to the voice leading of the
  cycle'' \parentext{\cite[15]{santa:2003}}.}
...
\fntext{maj3-18}{%
  % xxx note about bubble notation
...
\fntext{pvl-1}{%
  ...
  version, the voice leading to and from the French sixth chords is incorrect
  in two of the three ``towers.''}

\fntext{pvl-2}{%
  % xxx reread this, check for cross-type
...
\fntext{pvl-3}{%
  ...
  higher. Keeping the \slideS transformation intact in this circumstance would
