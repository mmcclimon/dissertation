...
\fntext{maj3-10}{%
  ``4-Cube Trio'' was originally devised by Jack Douthett, and is very similar
  to the ``Power Towers'' graphic in \cite[256]{douthettsteinbach:1998} (which
  omits the French sixth chords). For more on its history, see
...
\fntext{maj3-12}{%
  ...
  Jazz, as a music driven by seventh chords, is a fundamentally different
  animal, and requires a different approach.}
