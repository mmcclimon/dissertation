...
\fntext{ran-4}{%
  % xxx citation from Larson
  This difficulty is perhaps one of the reason that Steve Larson's book on the
  subject focuses on solo piano recordings of ``'Round Midnight,'' a piece in
  which the harmonies are well-defined (unlike Rhythm changes) and there are
  no other band members to muddy the waters. Garrett Michaelsen critiques
  Larson on this same point, and also suggests that Larson overemphasizes the
  importance of harmony in general
  \parentext{\headlesscite[9--10]{michaelsen:2013}}.}

\fntext{ran-5}{%
  % xxx fix this transcription
...
\fntext{ran-6}{%
  % xxx citation on comping
  ``Comping'' is what jazz musicians call the act of accompanying another
  soloist.}

\fntext{ran-7}{%
  % xxx check this history of the live dates
  \emph{Thelonious in Action} is a live recording made at the end of a long
  run at the Five Spot Cafe in New York. Ahmed Abdul-Malik was used to playing
  with Monk by the time of the recording, and catches the dominant-cycle A
  section almost immediately on the recording; Monk's strong left-hand
