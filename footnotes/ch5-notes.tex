...
\fntext{lj-5}{%
  % xxx need note about 7alt. chords.
  Recall that the ``altered chord'' has a specific meaning in jazz. To avoid
  confusion, and because they are prevalent throughout ``Lo-Joe,'' in this
  analysis the altered chord will be called ``\alt.''}
...
\fntext{lj-7}{%
  % xxx need page number
  This progression is given (in the key of \Bflat) in \cite[xxx]{aebersold:rhythm}.}
