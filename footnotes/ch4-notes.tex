...
\fntext{cst-7a}{%
  ...
  do avoid \sd4 in major scales, and so whether a given scale is Lydian or
...
\fntext{csa-19}{%
  ...
  section played the implied \h{Ebmaj7} in the fourth bar, suggested in Figure
  \ref{ds:displaced-cycle}.}
...
\fntext{csa-23}{%
  ...
  This operator should be read here as Hook's $t_k$ operator, which operates
  on ``floating diatonic forms,'' \emph{not} as the $t_k$ operator defined in
  Section \ref{sec:diatonic-spaces}. See \cite[139--41]{hook:2008} for
  details.}
...
\fntext{csa-25}{%
  ...
  \ref{maj3:four-cube-trio} gives the same voice-leading space.}
