...
\fntext{lcc-22}{%
  ...
  refers only to its ascending form, which is played both ascending and
  descending in jazz.}
...
\fntext{cst-7}{%
  ...
  Lydian \flat{}7 scale rather than the acoustic scale.}
...
\fntext{csa-11}{%
  ...
  bars of Figure \ref{csa:kirk-tfo-progs}, we assume F Lydian.}
