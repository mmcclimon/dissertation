...
\fntext{cst-7}{%
  These names have been chosen to reflect common jazz usage, so scale 4 is the
...
\fntext{cst-13}{%
  The use of $-7$ rather than $1$ in the second place here is intended to work
  around some of the limitations of using $\intZ_8$ as the group for the scale
  index \gis. The negative sign implies that the motion moves from dissonant
  to consonant, and the $7$ shows that this is a large move.}
...
\fntext{cst-18}{%
  ...
  ``anti-Lewin'' \parentext{\headlesscite{tymoczko:2008}}. For more on this
  tension, see Rachel Hall's review of \emph{GMIT};\nocite{hall:2009}
  \cite[especially 185--86]{hook:2007gmit}; and \cite[]{rings:2011}.}
