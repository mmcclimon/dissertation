...
\begin{figure}[tbp]
  \centerGraphic[width=28em]{eps/ch3/infant-eyes-changes.pdf}
...
``Tune Up'' (see Figure \ref{maj3:countdown-tune-up}).\fn{maj3-6} Because
Coltrane changes can be superimposed over any four-measure \tfo progression,
it can be found not only in Coltrane's own compositions, but also in his
improvisations on other tunes as well as his reharmonizations of standards
(like ``Body and Soul'').\fn{maj3-7}

\begin{figure}[tbp]
  \centerGraphic{eps/ch3/coltrane-substitution.pdf}
