...
\begin{figure}[tbp]
  ...
  \caption[Santa's nonatonic cycles.]{Santa's nonatonic cycles: the
    ``Western'' nonatonic cycle (left), and a three-voice parsimonious realization
    (right). (Adapted from ``Nonatonic Progressions in Coltrane,'' 14.)}
