...
individual progressions are not.\fn{maj3-4} ``Giant Steps''
is not exactly tonal, but neither is it truly atonal. When I listen to the
piece, at least, the impression is not one of ``nonfunctional harmony,'' but
rather one of tonal harmony used in an interesting way.
This distinction is best made by way of an example. Figure
\ref{maj3:infant-eyes-changes} gives the changes to Wayne Shorter's ballad
``Infant Eyes''; here there are no \tf{}s, nor even a strong V--I motion.
Shorter's use of harmony \emph{does} seem nonfunctional, and gives the piece a
floating quality that ``Giant Steps'' does not have. Rather, ``Giant Steps''
is strongly forward-directed: all of the dominant chords push toward their
...
dominants. This process can clearly be seen in Coltrane's composition
``Countdown,'' which is based on the changes to Miles Davis's ``Tune Up'' (see
Figure \ref{maj3:countdown-tune-up}).\fn{maj3-6} Because Coltrane changes can
be superimposed over any four-measure \tfo progression, it can be found
not only in Coltrane's own compositions, but also in his improvisations on
other tunes as well as his reharmonizations of standards (like ``Body and
Soul'').\fn{maj3-7}
...
\begin{figure}[tbp]
  ...
  \caption[Coltrane's major-third cycle as a substitution for a \tfo
    ...
    progression. (Adapted from Demsey, ``Chromatic Third Relations in the
    Music of John Coltrane,'' 160.)}
  \label{maj3:coltrane-substitution}
\end{figure}

\begin{figure}[tbp]
  \centerGraphic{eps/xxx.pdf}
  \caption{The changes to ``Countdown'' (Coltrane), along with those to
    ``Tune Up'' (Miles Davis).}
