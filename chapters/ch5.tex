...
with the piano and bass parts.\fn{lj-3} On the downbeats of the first and
...
the 13th, 9th, and 5th of this chord.\fn{lj-4}
...
\cst{Ab7}{$5$\flat}{xxx}. In either case, understanding the \h{Ab7} helps to
understand the harmony in the previous bar, which is a \h{Bb7}, again with
\sharp{}5 in Ruiz's voicing and \flat{}9 in the melody (and, in \cnum{A-3},
...
% xxx write this paragraph once figure is there
...
bass and with basic, three- and four-note voicings in the piano.\fn{lj-7}
