...
% xxx here, some text about the other players' roles in all of this
...
Figure \ref{ran:change-running-bass}.
% xxx: here, talk about this version of the harmony
While Abdul-Malik's bass line certainly provides insight into his conception
of the harmony of these four bars, it does not necessarily tell us anything
more about \emph{Griffin}'s harmonic understanding; it is entirely possible
(and common) that all band members do not share exactly the same harmonic
framework, especially in a Rhythm tune.
% We might hear Abdul-Malik's bass line as projecting the changes of Figure
% \ref{ran:jg-change-running}a, while Griffin's solo projects \emph{b} instead.
...
questions---questions, incidentally, which relate to my own suspicion of
the Schenkerian analysis of jazz first sketched in Section
...
through all of the solos, or is the harmonic framework constantly
reinterpreted? In order to make a Schenkerian voice-leading sketch of this
...
identify the underlying harmony.\fn{ran-3} My own contention is that the
