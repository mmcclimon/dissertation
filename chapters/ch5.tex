...
\ref{et:sr-side-slipping}) reach a final realization, before winding down in
the last chorus to prepare for Dizzy Gillespie's trumpet solo.
...
recording saying ``keep going?'' Stitt's first eight bars are a typical
...
\begin{figure}[tbp]
  ...
  \caption[Rollins's outside playing in the second A section of chorus 17.]{%
    Rollins's outside playing in the second A section of chorus 17 (mm.~521--28, 7:44).}
...
\begin{figure}[tbp]
  \centerGraphic{eps/xxx.pdf}
  \caption[Increased chromaticism in the final A section of chorus 17.]{%
    Increased chromaticism in the final A section of chorus 17 (mm.~537--42, 7:56).}
...
``C.T.A.'' harmonization of Figure \ref{rcg:rc-first-four}f. While the motive
and direction of the line are relatively clear, we might also hear this line,
in conjunction with Ray Bryant's comping in the last two bars, as a series of
outgoing scale choices on a more standard progression, as shown in Figure
\ref{et:sr-desc-motive}. Like Stitt, Rollins returns to a more diatonic
approach in the last four bars of the section, setting up the way for Stitt's
bridge.

\begin{figure}[tbp]
  \centerGraphic{eps/xxx.pdf}
  \caption[Possible interpretations of Rollins's descending line.]{%
    Possible interpretations of Rollins's descending line (mm.~553--56,
    8:09).}
...
chord before the expected \h{Cm7} in the second bar of the chorus. At this
point, the outside playing begins to subside, at least until Rollins's next
entrance.
% Talk about BM7 in 19A-2 (need transcription, probably), then inside for last
% 2 sections.
