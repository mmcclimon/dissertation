...
Rhythm tunes in his \emph{How to Learn Tunes}; some of the most well-known
...
of \emph{a} followed by the last two bars of \emph{d}, for example), those in
...
section is to provide the harmonic framework for the
...
basic principle of jazz harmony, in that progressions that are less commonplace are
...
pianists do not usually play identical voicings for a single chord throughout.
...
historical end of common-practice jazz: the tonality of the impressionists on
...
addition to the developments of the theory community).
