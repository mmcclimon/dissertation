...
% Here, need some text about how to determine what diatonic collections other
% scales belong to. This will transition into how we need some more
% information, namely a scale index and a chord symbol.
