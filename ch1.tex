...
\mbox{$S =$ \{\h{GmM7},} \h{Am7b5}, \h{BbM7}, \h{Cm7}, \h{D7}, \h{EbM7},
\h{F7}\}.
...
\mbox{int(\h{D7}, \h{GmM7}) = 3}, since G, the root of the second chord, lies
...
$t_3$ maps \h{Am7b5} onto \h{D7} in the space \mbox{$S =$ \{\h{GmM7},}
