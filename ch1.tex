...
realizing the phrase is in danger of C major too soon. We can capture this
intution by choosing to understand the progression not as a forward-directed
$t_5$, but as an algebraically-equivalent combination of three ascending
fifths ($t_3^{-1} + t_3^{-1} + t_3^{-1}$).
