...
The bridge of this tune is usually described as two \tfo\ progressions, the
first in G major and the second in E major. While this is true, we might
understand this progression as an alteration of a diatonic cycle in E minor.
The bridge begins on a iv chord, which initiates a \tfo\ in the relative
major. After two bars of \h{GM7}, a $t_6$ takes us to \h{Fsm7b5}. Just as in
the bridge to “Autumn Leaves,” we can understand this $t_6$ as a combination
of two $t_3$ operations, interpolating the missing \h{CM7} chord.\fn{ds-19}
Though the cycle of the bridge (and its associated GIS) is in the key of E
minor, the final chord is an E \emph{major} seventh, a kind of Picardy third
so that the bridge, like the A sections, can end on a major chord.
