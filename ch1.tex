...
musicians know (that “Autumn Leaves” contains a diatonic cycle) and then
applying transformational techniques, we can demonstrate that the gap between
the way jazz musicians discuss harmony need not be as far removed from the way
music theorists tend to discuss jazz harmony. The mathematical language used
by the theory is but a means to an end---a way of translating what is often
intuitive knowledge for jazz musicians (not a group well-known for their
rigorous use of language) to a language more familiar to music theorists.
...
Before concluding this chapter, it will be useful to examine “Autumn Leaves”
in a bit more detail, then move on to a few other analytical applications. The
...
\figBeg
  \centerGraphic{eps/xxx.pdf}
  \caption{A transformational network for “Autumn Leaves,” bridge.}
  \label{ds:autumn-leaves-bridge}
\figEnd

% TODO here:
%   - connection between bridge and last 8; t6 = two t3s
%   - how G- C7 F- Bb7 requires a new space (ii-V space), though the root
