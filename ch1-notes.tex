...
\fntext{ds-6}{%
  ...
  transformational thinking is \emph{the} central theme of \emph{GMIT}; see
...
\fntext{ds-7}{%
  Ramon Satyendra describes the two attitudes as being noun-oriented (GISs)
...
\fntext{ds-18}{%
  ...
  \h{FM7} as a pivot, in order to keep both \tfo\ progressions (in C major and
  A minor) intact.}
...
\fntext{ds-20}{%
  If the linking dominant did not occur at the end of the bridge, we would see
...
\fntext{ds-22}{%
  Hearing the third-relations does have the nice side effect, missing in our
