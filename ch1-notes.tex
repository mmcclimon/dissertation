...
\fntext{ds-1}{%
  Some text here about musical spaces, probably with reference to Jay’s
  upcoming book.}
...
\fntext{ds-2}{%
  ...
  with “\h{m7f5}”. In a minor key the tonic chord is typically played with a
...
\fntext{ds-3}{%
  ...
  since I am interested at this point only in its application to the diatonic
  set S.}
