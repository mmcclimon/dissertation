...
\blankfootnote{Jazz discography in the 21st century can be frustrating, given
  ...
  be as clear as possible in the discography, listing both original release
  information and more readily available reissues, when available. Three
  online sources have been invaluable in compiling this information: \emph{The Jazz
  Discography Project} (\url{http://www.jazzdisco.org}; Nobuaki Togashi, Kohji
  ``Shaolin'' Matsubayashi, and Masayuki Hatta, maintainers); \emph{Discogs}
  (\url{http://www.discogs.com}; created by Kevin Lewandowski); and \emph{AllMusic}
...
\vspace{-1em}
\tuneitem{``Anthropology'' -- Charlie Parker and Dizzy Gillespie}
\begin{compactitem}
...
\tuneitem{``Moose the Mooche'' -- Charlie Parker}
\begin{compactitem}
...
\tuneitem{``Serpent's Tooth'' -- Miles Davis}
\begin{compactitem}
